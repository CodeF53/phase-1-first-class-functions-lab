...
const returnLastTwoDrivers = (arr) => {return arr.slice(-2,arr.length)}

console.log(returnFirstTwoDrivers([0,1,2,3,4,5])); // 0,1
console.log(returnLastTwoDrivers([0,1,2,3,4,5])); // 4,5
